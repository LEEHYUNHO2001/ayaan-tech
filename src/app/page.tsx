...
export default function HomePage() {
  ...
  const blogHomeTextModel = {
    ...
    description: `안녕하세요, 프론트엔드 개발자 아얀입니다.
      어느덧 개발자로 일한지 ${getExperienceYear()}년이 되었네요.
      
      평소에 중요하다고 느낀 내용을 정리하고 기록하는 습관이 있는데, 정보를 공유하고 싶다는 마음에 블로그를 시작하게 되었습니다.
      
      개발자가 되기 전부터 기술 블로그를 작성했다 보니, 예전 글을 보면 다소 민망할때도 있습니다. 하지만 그 모든 기록이 저의 성장 과정이라 생각하기에 소중히 간직하고 있습니다.
